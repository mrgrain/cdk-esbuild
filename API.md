...
### EsbuildAsset <a name="EsbuildAsset" id="@mrgrain/cdk-esbuild.EsbuildAsset"></a>

Represents a generic esbuild asset.

You should always use `TypeScriptAsset` or `JavaScriptAsset`.

#### Initializers <a name="Initializers" id="@mrgrain/cdk-esbuild.EsbuildAsset.Initializer"></a>
...
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.Initializer.parameter.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.Initializer.parameter.props">props</a></code> | <code><a href="#@mrgrain/cdk-esbuild.AssetProps">AssetProps</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="@mrgrain/cdk-esbuild.EsbuildAsset.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="@mrgrain/cdk-esbuild.EsbuildAsset.Initializer.parameter.id"></a>

- *Type:* string

---

##### `props`<sup>Required</sup> <a name="props" id="@mrgrain/cdk-esbuild.EsbuildAsset.Initializer.parameter.props"></a>

- *Type:* <a href="#@mrgrain/cdk-esbuild.AssetProps">AssetProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.addResourceMetadata">addResourceMetadata</a></code> | Adds CloudFormation template metadata to the specified resource with information that indicates which resource property is mapped to this local asset. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.grantRead">grantRead</a></code> | Grants read permissions to the principal on the assets bucket. |

---

##### `toString` <a name="toString" id="@mrgrain/cdk-esbuild.EsbuildAsset.toString"></a>
...
##### `addResourceMetadata` <a name="addResourceMetadata" id="@mrgrain/cdk-esbuild.EsbuildAsset.addResourceMetadata"></a>
...
###### `resource`<sup>Required</sup> <a name="resource" id="@mrgrain/cdk-esbuild.EsbuildAsset.addResourceMetadata.parameter.resource"></a>
...
###### `resourceProperty`<sup>Required</sup> <a name="resourceProperty" id="@mrgrain/cdk-esbuild.EsbuildAsset.addResourceMetadata.parameter.resourceProperty"></a>
...
##### `grantRead` <a name="grantRead" id="@mrgrain/cdk-esbuild.EsbuildAsset.grantRead"></a>
...
###### `grantee`<sup>Required</sup> <a name="grantee" id="@mrgrain/cdk-esbuild.EsbuildAsset.grantRead.parameter.grantee"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### ~~`isConstruct`~~ <a name="isConstruct" id="@mrgrain/cdk-esbuild.EsbuildAsset.isConstruct"></a>

```typescript
import { EsbuildAsset } from '@mrgrain/cdk-esbuild'

EsbuildAsset.isConstruct(x: any)
```

Checks if `x` is a construct.

###### `x`<sup>Required</sup> <a name="x" id="@mrgrain/cdk-esbuild.EsbuildAsset.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.assetHash">assetHash</a></code> | <code>string</code> | A hash of this asset, which is available at construction time. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.assetPath">assetPath</a></code> | <code>string</code> | The path to the asset, relative to the current Cloud Assembly. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.bucket">bucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | The S3 bucket in which this asset resides. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.httpUrl">httpUrl</a></code> | <code>string</code> | Attribute which represents the S3 HTTP URL of this asset. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.isFile">isFile</a></code> | <code>boolean</code> | Indicates if this asset is a single file. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.isZipArchive">isZipArchive</a></code> | <code>boolean</code> | Indicates if this asset is a zip archive. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.s3BucketName">s3BucketName</a></code> | <code>string</code> | Attribute that represents the name of the bucket this asset exists in. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.s3ObjectKey">s3ObjectKey</a></code> | <code>string</code> | Attribute which represents the S3 object key of this asset. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildAsset.property.s3ObjectUrl">s3ObjectUrl</a></code> | <code>string</code> | Attribute which represents the S3 URL of this asset. |

---

##### `node`<sup>Required</sup> <a name="node" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.node"></a>
...
##### `assetHash`<sup>Required</sup> <a name="assetHash" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.assetHash"></a>
...
##### `assetPath`<sup>Required</sup> <a name="assetPath" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.assetPath"></a>
...
##### `bucket`<sup>Required</sup> <a name="bucket" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.bucket"></a>
...
##### `httpUrl`<sup>Required</sup> <a name="httpUrl" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.httpUrl"></a>
...
##### `isFile`<sup>Required</sup> <a name="isFile" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.isFile"></a>
...
##### `isZipArchive`<sup>Required</sup> <a name="isZipArchive" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.isZipArchive"></a>
...
##### `s3BucketName`<sup>Required</sup> <a name="s3BucketName" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.s3BucketName"></a>
...
##### `s3ObjectKey`<sup>Required</sup> <a name="s3ObjectKey" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.s3ObjectKey"></a>
...
##### `s3ObjectUrl`<sup>Required</sup> <a name="s3ObjectUrl" id="@mrgrain/cdk-esbuild.EsbuildAsset.property.s3ObjectUrl"></a>
...
### JavaScriptAsset <a name="JavaScriptAsset" id="@mrgrain/cdk-esbuild.JavaScriptAsset"></a>
...
#### Initializers <a name="Initializers" id="@mrgrain/cdk-esbuild.JavaScriptAsset.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.Initializer.parameter.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.Initializer.parameter.props">props</a></code> | <code><a href="#@mrgrain/cdk-esbuild.AssetProps">AssetProps</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="@mrgrain/cdk-esbuild.JavaScriptAsset.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="@mrgrain/cdk-esbuild.JavaScriptAsset.Initializer.parameter.id"></a>

- *Type:* string

---

##### `props`<sup>Required</sup> <a name="props" id="@mrgrain/cdk-esbuild.JavaScriptAsset.Initializer.parameter.props"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.addResourceMetadata">addResourceMetadata</a></code> | Adds CloudFormation template metadata to the specified resource with information that indicates which resource property is mapped to this local asset. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.grantRead">grantRead</a></code> | Grants read permissions to the principal on the assets bucket. |

---

##### `toString` <a name="toString" id="@mrgrain/cdk-esbuild.JavaScriptAsset.toString"></a>
...
##### `addResourceMetadata` <a name="addResourceMetadata" id="@mrgrain/cdk-esbuild.JavaScriptAsset.addResourceMetadata"></a>
...
###### `resource`<sup>Required</sup> <a name="resource" id="@mrgrain/cdk-esbuild.JavaScriptAsset.addResourceMetadata.parameter.resource"></a>
...
###### `resourceProperty`<sup>Required</sup> <a name="resourceProperty" id="@mrgrain/cdk-esbuild.JavaScriptAsset.addResourceMetadata.parameter.resourceProperty"></a>
...
##### `grantRead` <a name="grantRead" id="@mrgrain/cdk-esbuild.JavaScriptAsset.grantRead"></a>
...
###### `grantee`<sup>Required</sup> <a name="grantee" id="@mrgrain/cdk-esbuild.JavaScriptAsset.grantRead.parameter.grantee"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### ~~`isConstruct`~~ <a name="isConstruct" id="@mrgrain/cdk-esbuild.JavaScriptAsset.isConstruct"></a>

```typescript
import { JavaScriptAsset } from '@mrgrain/cdk-esbuild'

JavaScriptAsset.isConstruct(x: any)
```

Checks if `x` is a construct.

###### `x`<sup>Required</sup> <a name="x" id="@mrgrain/cdk-esbuild.JavaScriptAsset.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.assetHash">assetHash</a></code> | <code>string</code> | A hash of this asset, which is available at construction time. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.assetPath">assetPath</a></code> | <code>string</code> | The path to the asset, relative to the current Cloud Assembly. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.bucket">bucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | The S3 bucket in which this asset resides. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.httpUrl">httpUrl</a></code> | <code>string</code> | Attribute which represents the S3 HTTP URL of this asset. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.isFile">isFile</a></code> | <code>boolean</code> | Indicates if this asset is a single file. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.isZipArchive">isZipArchive</a></code> | <code>boolean</code> | Indicates if this asset is a zip archive. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.s3BucketName">s3BucketName</a></code> | <code>string</code> | Attribute that represents the name of the bucket this asset exists in. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.s3ObjectKey">s3ObjectKey</a></code> | <code>string</code> | Attribute which represents the S3 object key of this asset. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset.property.s3ObjectUrl">s3ObjectUrl</a></code> | <code>string</code> | Attribute which represents the S3 URL of this asset. |

---

##### `node`<sup>Required</sup> <a name="node" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.node"></a>
...
##### `assetHash`<sup>Required</sup> <a name="assetHash" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.assetHash"></a>
...
##### `assetPath`<sup>Required</sup> <a name="assetPath" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.assetPath"></a>
...
##### `bucket`<sup>Required</sup> <a name="bucket" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.bucket"></a>
...
##### `httpUrl`<sup>Required</sup> <a name="httpUrl" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.httpUrl"></a>
...
##### `isFile`<sup>Required</sup> <a name="isFile" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.isFile"></a>
...
##### `isZipArchive`<sup>Required</sup> <a name="isZipArchive" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.isZipArchive"></a>
...
##### `s3BucketName`<sup>Required</sup> <a name="s3BucketName" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.s3BucketName"></a>
...
##### `s3ObjectKey`<sup>Required</sup> <a name="s3ObjectKey" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.s3ObjectKey"></a>
...
##### `s3ObjectUrl`<sup>Required</sup> <a name="s3ObjectUrl" id="@mrgrain/cdk-esbuild.JavaScriptAsset.property.s3ObjectUrl"></a>
...
| <code><a href="#@mrgrain/cdk-esbuild.TypeScriptAsset.Initializer.parameter.props">props</a></code> | <code><a href="#@mrgrain/cdk-esbuild.AssetProps">AssetProps</a></code> | *No description.* |
...
### AssetProps <a name="AssetProps" id="@mrgrain/cdk-esbuild.AssetProps"></a>

#### Initializer <a name="Initializer" id="@mrgrain/cdk-esbuild.AssetProps.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.AssetProps.property.buildOptions">buildOptions</a></code> | <code><a href="#@mrgrain/cdk-esbuild.BuildOptions">BuildOptions</a></code> | Build options passed on to esbuild. Please refer to the esbuild Build API docs for details. |
| <code><a href="#@mrgrain/cdk-esbuild.AssetProps.property.buildProvider">buildProvider</a></code> | <code><a href="#@mrgrain/cdk-esbuild.IBuildProvider">IBuildProvider</a></code> | The esbuild Build API implementation to be used. |
| <code><a href="#@mrgrain/cdk-esbuild.AssetProps.property.copyDir">copyDir</a></code> | <code>string \| string[] \| {[ key: string ]: string \| string[]}</code> | Copy additional files to the code [asset staging directory](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.AssetStaging.html#absolutestagedpath), before the build runs. Files copied like this will be overwritten by esbuild if they share the same name as any of the outputs. |
| <code><a href="#@mrgrain/cdk-esbuild.AssetProps.property.entryPoints">entryPoints</a></code> | <code>string \| string[] \| {[ key: string ]: string}</code> | A path or list or map of paths to the entry points of your code. |
| <code><a href="#@mrgrain/cdk-esbuild.AssetProps.property.assetHash">assetHash</a></code> | <code>string</code> | A hash of this asset, which is available at construction time. |

---

##### `buildOptions`<sup>Optional</sup> <a name="buildOptions" id="@mrgrain/cdk-esbuild.AssetProps.property.buildOptions"></a>
...
##### `buildProvider`<sup>Optional</sup> <a name="buildProvider" id="@mrgrain/cdk-esbuild.AssetProps.property.buildProvider"></a>
...
##### `copyDir`<sup>Optional</sup> <a name="copyDir" id="@mrgrain/cdk-esbuild.AssetProps.property.copyDir"></a>
...
##### `entryPoints`<sup>Required</sup> <a name="entryPoints" id="@mrgrain/cdk-esbuild.AssetProps.property.entryPoints"></a>
...
##### `assetHash`<sup>Optional</sup> <a name="assetHash" id="@mrgrain/cdk-esbuild.AssetProps.property.assetHash"></a>
...
| <code><a href="#@mrgrain/cdk-esbuild.BuildOptions.property.tsconfigRaw">tsconfigRaw</a></code> | <code>string \| <a href="#@mrgrain/cdk-esbuild.TsconfigOptions">TsconfigOptions</a></code> | Documentation: https://esbuild.github.io/api/#tsconfig-raw. |
...
- *Type:* string | <a href="#@mrgrain/cdk-esbuild.TsconfigOptions">TsconfigOptions</a>
...
### JavaScriptCodeProps <a name="JavaScriptCodeProps" id="@mrgrain/cdk-esbuild.JavaScriptCodeProps"></a>

#### Initializer <a name="Initializer" id="@mrgrain/cdk-esbuild.JavaScriptCodeProps.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCodeProps.property.buildOptions">buildOptions</a></code> | <code><a href="#@mrgrain/cdk-esbuild.BuildOptions">BuildOptions</a></code> | Build options passed on to esbuild. Please refer to the esbuild Build API docs for details. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCodeProps.property.buildProvider">buildProvider</a></code> | <code><a href="#@mrgrain/cdk-esbuild.IBuildProvider">IBuildProvider</a></code> | The esbuild Build API implementation to be used. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCodeProps.property.copyDir">copyDir</a></code> | <code>string \| string[] \| {[ key: string ]: string \| string[]}</code> | Copy additional files to the code [asset staging directory](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.AssetStaging.html#absolutestagedpath), before the build runs. Files copied like this will be overwritten by esbuild if they share the same name as any of the outputs. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCodeProps.property.assetHash">assetHash</a></code> | <code>string</code> | A hash of this asset, which is available at construction time. |

---

##### `buildOptions`<sup>Optional</sup> <a name="buildOptions" id="@mrgrain/cdk-esbuild.JavaScriptCodeProps.property.buildOptions"></a>
...
##### `buildProvider`<sup>Optional</sup> <a name="buildProvider" id="@mrgrain/cdk-esbuild.JavaScriptCodeProps.property.buildProvider"></a>
...
##### `copyDir`<sup>Optional</sup> <a name="copyDir" id="@mrgrain/cdk-esbuild.JavaScriptCodeProps.property.copyDir"></a>
...
##### `assetHash`<sup>Optional</sup> <a name="assetHash" id="@mrgrain/cdk-esbuild.JavaScriptCodeProps.property.assetHash"></a>
...
### JavaScriptSourceProps <a name="JavaScriptSourceProps" id="@mrgrain/cdk-esbuild.JavaScriptSourceProps"></a>

#### Initializer <a name="Initializer" id="@mrgrain/cdk-esbuild.JavaScriptSourceProps.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSourceProps.property.buildOptions">buildOptions</a></code> | <code><a href="#@mrgrain/cdk-esbuild.BuildOptions">BuildOptions</a></code> | Build options passed on to esbuild. Please refer to the esbuild Build API docs for details. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSourceProps.property.buildProvider">buildProvider</a></code> | <code><a href="#@mrgrain/cdk-esbuild.IBuildProvider">IBuildProvider</a></code> | The esbuild Build API implementation to be used. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSourceProps.property.copyDir">copyDir</a></code> | <code>string \| string[] \| {[ key: string ]: string \| string[]}</code> | Copy additional files to the code [asset staging directory](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.AssetStaging.html#absolutestagedpath), before the build runs. Files copied like this will be overwritten by esbuild if they share the same name as any of the outputs. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSourceProps.property.assetHash">assetHash</a></code> | <code>string</code> | A hash of this asset, which is available at construction time. |

---

##### `buildOptions`<sup>Optional</sup> <a name="buildOptions" id="@mrgrain/cdk-esbuild.JavaScriptSourceProps.property.buildOptions"></a>
...
##### `buildProvider`<sup>Optional</sup> <a name="buildProvider" id="@mrgrain/cdk-esbuild.JavaScriptSourceProps.property.buildProvider"></a>
...
##### `copyDir`<sup>Optional</sup> <a name="copyDir" id="@mrgrain/cdk-esbuild.JavaScriptSourceProps.property.copyDir"></a>
...
##### `assetHash`<sup>Optional</sup> <a name="assetHash" id="@mrgrain/cdk-esbuild.JavaScriptSourceProps.property.assetHash"></a>
...
| <code><a href="#@mrgrain/cdk-esbuild.ProviderBuildOptions.property.tsconfigRaw">tsconfigRaw</a></code> | <code>string \| <a href="#@mrgrain/cdk-esbuild.TsconfigOptions">TsconfigOptions</a></code> | Documentation: https://esbuild.github.io/api/#tsconfig-raw. |
...
| <code><a href="#@mrgrain/cdk-esbuild.ProviderTransformOptions.property.tsconfigRaw">tsconfigRaw</a></code> | <code>string \| <a href="#@mrgrain/cdk-esbuild.TsconfigOptions">TsconfigOptions</a></code> | Documentation: https://esbuild.github.io/api/#tsconfig-raw. |
...
| <code><a href="#@mrgrain/cdk-esbuild.TransformOptions.property.tsconfigRaw">tsconfigRaw</a></code> | <code>string \| <a href="#@mrgrain/cdk-esbuild.TsconfigOptions">TsconfigOptions</a></code> | Documentation: https://esbuild.github.io/api/#tsconfig-raw. |
...
### TsconfigOptions <a name="TsconfigOptions" id="@mrgrain/cdk-esbuild.TsconfigOptions"></a>

#### Initializer <a name="Initializer" id="@mrgrain/cdk-esbuild.TsconfigOptions.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.TsconfigOptions.property.compilerOptions">compilerOptions</a></code> | <code><a href="#@mrgrain/cdk-esbuild.CompilerOptions">CompilerOptions</a></code> | *No description.* |

---

##### `compilerOptions`<sup>Optional</sup> <a name="compilerOptions" id="@mrgrain/cdk-esbuild.TsconfigOptions.property.compilerOptions"></a>
...
### EsbuildCode <a name="EsbuildCode" id="@mrgrain/cdk-esbuild.EsbuildCode"></a>

Represents a generic esbuild code bundle.

You should always use `TypeScriptCode` or `JavaScriptCode`.

#### Initializers <a name="Initializers" id="@mrgrain/cdk-esbuild.EsbuildCode.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.Initializer.parameter.entryPoints">entryPoints</a></code> | <code>string \| string[] \| {[ key: string ]: string}</code> | A path or list or map of paths to the entry points of your code. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.Initializer.parameter.props">props</a></code> | <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCodeProps">JavaScriptCodeProps</a> \| <a href="#@mrgrain/cdk-esbuild.TypeScriptCodeProps">TypeScriptCodeProps</a></code> | Props to change the behavior of the bundler. |

---

##### `entryPoints`<sup>Required</sup> <a name="entryPoints" id="@mrgrain/cdk-esbuild.EsbuildCode.Initializer.parameter.entryPoints"></a>
...
##### `props`<sup>Required</sup> <a name="props" id="@mrgrain/cdk-esbuild.EsbuildCode.Initializer.parameter.props"></a>

- *Type:* <a href="#@mrgrain/cdk-esbuild.JavaScriptCodeProps">JavaScriptCodeProps</a> | <a href="#@mrgrain/cdk-esbuild.TypeScriptCodeProps">TypeScriptCodeProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.bind">bind</a></code> | Called when the lambda or layer is initialized to allow this object to bind to the stack, add resources and have fun. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.bindToResource">bindToResource</a></code> | Called after the CFN function resource has been created to allow the code class to bind to it. |

---

##### `bind` <a name="bind" id="@mrgrain/cdk-esbuild.EsbuildCode.bind"></a>
...
###### `scope`<sup>Required</sup> <a name="scope" id="@mrgrain/cdk-esbuild.EsbuildCode.bind.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `bindToResource` <a name="bindToResource" id="@mrgrain/cdk-esbuild.EsbuildCode.bindToResource"></a>
...
###### `resource`<sup>Required</sup> <a name="resource" id="@mrgrain/cdk-esbuild.EsbuildCode.bindToResource.parameter.resource"></a>

- *Type:* aws-cdk-lib.CfnResource

---

###### `options`<sup>Optional</sup> <a name="options" id="@mrgrain/cdk-esbuild.EsbuildCode.bindToResource.parameter.options"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.fromAsset">fromAsset</a></code> | Loads the function code from a local disk path. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.fromAssetImage">fromAssetImage</a></code> | Create an ECR image from the specified asset and bind it as the Lambda code. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.fromBucket">fromBucket</a></code> | Lambda handler code as an S3 object. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.fromCfnParameters">fromCfnParameters</a></code> | Creates a new Lambda source defined using CloudFormation parameters. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.fromDockerBuild">fromDockerBuild</a></code> | Loads the function code from an asset created by a Docker build. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.fromEcrImage">fromEcrImage</a></code> | Use an existing ECR image as the Lambda code. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.fromInline">fromInline</a></code> | Inline code for Lambda handler. |

---

##### `fromAsset` <a name="fromAsset" id="@mrgrain/cdk-esbuild.EsbuildCode.fromAsset"></a>

```typescript
import { EsbuildCode } from '@mrgrain/cdk-esbuild'

EsbuildCode.fromAsset(path: string, options?: AssetOptions)
```

Loads the function code from a local disk path.

###### `path`<sup>Required</sup> <a name="path" id="@mrgrain/cdk-esbuild.EsbuildCode.fromAsset.parameter.path"></a>
...
###### `options`<sup>Optional</sup> <a name="options" id="@mrgrain/cdk-esbuild.EsbuildCode.fromAsset.parameter.options"></a>

- *Type:* aws-cdk-lib.aws_s3_assets.AssetOptions

---

##### `fromAssetImage` <a name="fromAssetImage" id="@mrgrain/cdk-esbuild.EsbuildCode.fromAssetImage"></a>

```typescript
import { EsbuildCode } from '@mrgrain/cdk-esbuild'

EsbuildCode.fromAssetImage(directory: string, props?: AssetImageCodeProps)
```

Create an ECR image from the specified asset and bind it as the Lambda code.

###### `directory`<sup>Required</sup> <a name="directory" id="@mrgrain/cdk-esbuild.EsbuildCode.fromAssetImage.parameter.directory"></a>
...
###### `props`<sup>Optional</sup> <a name="props" id="@mrgrain/cdk-esbuild.EsbuildCode.fromAssetImage.parameter.props"></a>
...
##### `fromBucket` <a name="fromBucket" id="@mrgrain/cdk-esbuild.EsbuildCode.fromBucket"></a>

```typescript
import { EsbuildCode } from '@mrgrain/cdk-esbuild'

EsbuildCode.fromBucket(bucket: IBucket, key: string, objectVersion?: string)
```

Lambda handler code as an S3 object.

###### `bucket`<sup>Required</sup> <a name="bucket" id="@mrgrain/cdk-esbuild.EsbuildCode.fromBucket.parameter.bucket"></a>
...
###### `key`<sup>Required</sup> <a name="key" id="@mrgrain/cdk-esbuild.EsbuildCode.fromBucket.parameter.key"></a>
...
###### `objectVersion`<sup>Optional</sup> <a name="objectVersion" id="@mrgrain/cdk-esbuild.EsbuildCode.fromBucket.parameter.objectVersion"></a>
...
##### `fromCfnParameters` <a name="fromCfnParameters" id="@mrgrain/cdk-esbuild.EsbuildCode.fromCfnParameters"></a>

```typescript
import { EsbuildCode } from '@mrgrain/cdk-esbuild'

EsbuildCode.fromCfnParameters(props?: CfnParametersCodeProps)
```

Creates a new Lambda source defined using CloudFormation parameters.

###### `props`<sup>Optional</sup> <a name="props" id="@mrgrain/cdk-esbuild.EsbuildCode.fromCfnParameters.parameter.props"></a>
...
##### `fromDockerBuild` <a name="fromDockerBuild" id="@mrgrain/cdk-esbuild.EsbuildCode.fromDockerBuild"></a>

```typescript
import { EsbuildCode } from '@mrgrain/cdk-esbuild'

EsbuildCode.fromDockerBuild(path: string, options?: DockerBuildAssetOptions)
```
...
###### `path`<sup>Required</sup> <a name="path" id="@mrgrain/cdk-esbuild.EsbuildCode.fromDockerBuild.parameter.path"></a>
...
###### `options`<sup>Optional</sup> <a name="options" id="@mrgrain/cdk-esbuild.EsbuildCode.fromDockerBuild.parameter.options"></a>
...
##### `fromEcrImage` <a name="fromEcrImage" id="@mrgrain/cdk-esbuild.EsbuildCode.fromEcrImage"></a>

```typescript
import { EsbuildCode } from '@mrgrain/cdk-esbuild'

EsbuildCode.fromEcrImage(repository: IRepository, props?: EcrImageCodeProps)
```

Use an existing ECR image as the Lambda code.

###### `repository`<sup>Required</sup> <a name="repository" id="@mrgrain/cdk-esbuild.EsbuildCode.fromEcrImage.parameter.repository"></a>
...
###### `props`<sup>Optional</sup> <a name="props" id="@mrgrain/cdk-esbuild.EsbuildCode.fromEcrImage.parameter.props"></a>
...
##### `fromInline` <a name="fromInline" id="@mrgrain/cdk-esbuild.EsbuildCode.fromInline"></a>

```typescript
import { EsbuildCode } from '@mrgrain/cdk-esbuild'

EsbuildCode.fromInline(code: string)
```

Inline code for Lambda handler.

###### `code`<sup>Required</sup> <a name="code" id="@mrgrain/cdk-esbuild.EsbuildCode.fromInline.parameter.code"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.property.entryPoints">entryPoints</a></code> | <code>string \| string[] \| {[ key: string ]: string}</code> | A path or list or map of paths to the entry points of your code. |
| <code><a href="#@mrgrain/cdk-esbuild.EsbuildCode.property.isInline">isInline</a></code> | <code>boolean</code> | Determines whether this Code is inline code or not. |

---

##### `entryPoints`<sup>Required</sup> <a name="entryPoints" id="@mrgrain/cdk-esbuild.EsbuildCode.property.entryPoints"></a>
...
##### ~~`isInline`~~<sup>Required</sup> <a name="isInline" id="@mrgrain/cdk-esbuild.EsbuildCode.property.isInline"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.InlineJavaScriptCode.property.isInline">isInline</a></code> | <code>boolean</code> | Determines whether this Code is inline code or not. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.InlineTypeScriptCode.property.isInline">isInline</a></code> | <code>boolean</code> | Determines whether this Code is inline code or not. |
...
### JavaScriptCode <a name="JavaScriptCode" id="@mrgrain/cdk-esbuild.JavaScriptCode"></a>

Represents the deployed JavaScript Code.

#### Initializers <a name="Initializers" id="@mrgrain/cdk-esbuild.JavaScriptCode.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.Initializer.parameter.entryPoints">entryPoints</a></code> | <code>string \| string[] \| {[ key: string ]: string}</code> | A path or list or map of paths to the entry points of your code. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.Initializer.parameter.props">props</a></code> | <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCodeProps">JavaScriptCodeProps</a></code> | Props to change the behavior of the bundler. |

---

##### `entryPoints`<sup>Required</sup> <a name="entryPoints" id="@mrgrain/cdk-esbuild.JavaScriptCode.Initializer.parameter.entryPoints"></a>
...
##### `props`<sup>Optional</sup> <a name="props" id="@mrgrain/cdk-esbuild.JavaScriptCode.Initializer.parameter.props"></a>

- *Type:* <a href="#@mrgrain/cdk-esbuild.JavaScriptCodeProps">JavaScriptCodeProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.bind">bind</a></code> | Called when the lambda or layer is initialized to allow this object to bind to the stack, add resources and have fun. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.bindToResource">bindToResource</a></code> | Called after the CFN function resource has been created to allow the code class to bind to it. |

---

##### `bind` <a name="bind" id="@mrgrain/cdk-esbuild.JavaScriptCode.bind"></a>
...
###### `scope`<sup>Required</sup> <a name="scope" id="@mrgrain/cdk-esbuild.JavaScriptCode.bind.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `bindToResource` <a name="bindToResource" id="@mrgrain/cdk-esbuild.JavaScriptCode.bindToResource"></a>
...
###### `resource`<sup>Required</sup> <a name="resource" id="@mrgrain/cdk-esbuild.JavaScriptCode.bindToResource.parameter.resource"></a>

- *Type:* aws-cdk-lib.CfnResource

---

###### `options`<sup>Optional</sup> <a name="options" id="@mrgrain/cdk-esbuild.JavaScriptCode.bindToResource.parameter.options"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.fromAsset">fromAsset</a></code> | Loads the function code from a local disk path. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.fromAssetImage">fromAssetImage</a></code> | Create an ECR image from the specified asset and bind it as the Lambda code. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.fromBucket">fromBucket</a></code> | Lambda handler code as an S3 object. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.fromCfnParameters">fromCfnParameters</a></code> | Creates a new Lambda source defined using CloudFormation parameters. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.fromDockerBuild">fromDockerBuild</a></code> | Loads the function code from an asset created by a Docker build. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.fromEcrImage">fromEcrImage</a></code> | Use an existing ECR image as the Lambda code. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.fromInline">fromInline</a></code> | Inline code for Lambda handler. |

---

##### `fromAsset` <a name="fromAsset" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromAsset"></a>

```typescript
import { JavaScriptCode } from '@mrgrain/cdk-esbuild'

JavaScriptCode.fromAsset(path: string, options?: AssetOptions)
```

Loads the function code from a local disk path.

###### `path`<sup>Required</sup> <a name="path" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromAsset.parameter.path"></a>
...
###### `options`<sup>Optional</sup> <a name="options" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromAsset.parameter.options"></a>

- *Type:* aws-cdk-lib.aws_s3_assets.AssetOptions

---

##### `fromAssetImage` <a name="fromAssetImage" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromAssetImage"></a>

```typescript
import { JavaScriptCode } from '@mrgrain/cdk-esbuild'

JavaScriptCode.fromAssetImage(directory: string, props?: AssetImageCodeProps)
```

Create an ECR image from the specified asset and bind it as the Lambda code.

###### `directory`<sup>Required</sup> <a name="directory" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromAssetImage.parameter.directory"></a>
...
###### `props`<sup>Optional</sup> <a name="props" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromAssetImage.parameter.props"></a>
...
##### `fromBucket` <a name="fromBucket" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromBucket"></a>

```typescript
import { JavaScriptCode } from '@mrgrain/cdk-esbuild'

JavaScriptCode.fromBucket(bucket: IBucket, key: string, objectVersion?: string)
```

Lambda handler code as an S3 object.

###### `bucket`<sup>Required</sup> <a name="bucket" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromBucket.parameter.bucket"></a>
...
###### `key`<sup>Required</sup> <a name="key" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromBucket.parameter.key"></a>
...
###### `objectVersion`<sup>Optional</sup> <a name="objectVersion" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromBucket.parameter.objectVersion"></a>
...
##### `fromCfnParameters` <a name="fromCfnParameters" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromCfnParameters"></a>

```typescript
import { JavaScriptCode } from '@mrgrain/cdk-esbuild'

JavaScriptCode.fromCfnParameters(props?: CfnParametersCodeProps)
```

Creates a new Lambda source defined using CloudFormation parameters.

###### `props`<sup>Optional</sup> <a name="props" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromCfnParameters.parameter.props"></a>
...
##### `fromDockerBuild` <a name="fromDockerBuild" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromDockerBuild"></a>

```typescript
import { JavaScriptCode } from '@mrgrain/cdk-esbuild'

JavaScriptCode.fromDockerBuild(path: string, options?: DockerBuildAssetOptions)
```
...
###### `path`<sup>Required</sup> <a name="path" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromDockerBuild.parameter.path"></a>
...
###### `options`<sup>Optional</sup> <a name="options" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromDockerBuild.parameter.options"></a>
...
##### `fromEcrImage` <a name="fromEcrImage" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromEcrImage"></a>

```typescript
import { JavaScriptCode } from '@mrgrain/cdk-esbuild'

JavaScriptCode.fromEcrImage(repository: IRepository, props?: EcrImageCodeProps)
```

Use an existing ECR image as the Lambda code.

###### `repository`<sup>Required</sup> <a name="repository" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromEcrImage.parameter.repository"></a>
...
###### `props`<sup>Optional</sup> <a name="props" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromEcrImage.parameter.props"></a>
...
##### `fromInline` <a name="fromInline" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromInline"></a>

```typescript
import { JavaScriptCode } from '@mrgrain/cdk-esbuild'

JavaScriptCode.fromInline(code: string)
```

Inline code for Lambda handler.

###### `code`<sup>Required</sup> <a name="code" id="@mrgrain/cdk-esbuild.JavaScriptCode.fromInline.parameter.code"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.property.entryPoints">entryPoints</a></code> | <code>string \| string[] \| {[ key: string ]: string}</code> | A path or list or map of paths to the entry points of your code. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptCode.property.isInline">isInline</a></code> | <code>boolean</code> | Determines whether this Code is inline code or not. |

---

##### `entryPoints`<sup>Required</sup> <a name="entryPoints" id="@mrgrain/cdk-esbuild.JavaScriptCode.property.entryPoints"></a>
...
##### ~~`isInline`~~<sup>Required</sup> <a name="isInline" id="@mrgrain/cdk-esbuild.JavaScriptCode.property.isInline"></a>
...
### JavaScriptSource <a name="JavaScriptSource" id="@mrgrain/cdk-esbuild.JavaScriptSource"></a>

- *Implements:* aws-cdk-lib.aws_s3_deployment.ISource

#### Initializers <a name="Initializers" id="@mrgrain/cdk-esbuild.JavaScriptSource.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSource.Initializer.parameter.entryPoints">entryPoints</a></code> | <code>string \| string[] \| {[ key: string ]: string}</code> | A path or list or map of paths to the entry points of your code. |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSource.Initializer.parameter.props">props</a></code> | <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSourceProps">JavaScriptSourceProps</a></code> | Props to change the behavior of the bundler. |

---

##### `entryPoints`<sup>Required</sup> <a name="entryPoints" id="@mrgrain/cdk-esbuild.JavaScriptSource.Initializer.parameter.entryPoints"></a>
...
##### `props`<sup>Optional</sup> <a name="props" id="@mrgrain/cdk-esbuild.JavaScriptSource.Initializer.parameter.props"></a>

- *Type:* <a href="#@mrgrain/cdk-esbuild.JavaScriptSourceProps">JavaScriptSourceProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSource.bind">bind</a></code> | Binds the source to a bucket deployment. |

---

##### `bind` <a name="bind" id="@mrgrain/cdk-esbuild.JavaScriptSource.bind"></a>
...
###### `scope`<sup>Required</sup> <a name="scope" id="@mrgrain/cdk-esbuild.JavaScriptSource.bind.parameter.scope"></a>

- *Type:* constructs.Construct

---

###### `context`<sup>Optional</sup> <a name="context" id="@mrgrain/cdk-esbuild.JavaScriptSource.bind.parameter.context"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.JavaScriptSource.property.assetClass">assetClass</a></code> | <code><a href="#@mrgrain/cdk-esbuild.JavaScriptAsset">JavaScriptAsset</a></code> | *No description.* |

---

##### `assetClass`<sup>Required</sup> <a name="assetClass" id="@mrgrain/cdk-esbuild.JavaScriptSource.property.assetClass"></a>

```typescript
public readonly assetClass: JavaScriptAsset;
```

- *Type:* <a href="#@mrgrain/cdk-esbuild.JavaScriptAsset">JavaScriptAsset</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.TypeScriptCode.property.entryPoints">entryPoints</a></code> | <code>string \| string[] \| {[ key: string ]: string}</code> | A path or list or map of paths to the entry points of your code. |
...
##### `entryPoints`<sup>Required</sup> <a name="entryPoints" id="@mrgrain/cdk-esbuild.TypeScriptCode.property.entryPoints"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mrgrain/cdk-esbuild.TypeScriptSource.property.assetClass">assetClass</a></code> | <code><a href="#@mrgrain/cdk-esbuild.TypeScriptAsset">TypeScriptAsset</a></code> | *No description.* |

---

##### `assetClass`<sup>Required</sup> <a name="assetClass" id="@mrgrain/cdk-esbuild.TypeScriptSource.property.assetClass"></a>

```typescript
public readonly assetClass: TypeScriptAsset;
```

- *Type:* <a href="#@mrgrain/cdk-esbuild.TypeScriptAsset">TypeScriptAsset</a>
